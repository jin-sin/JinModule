...
/**
 * Zooming view.
 * @author Jin on 2019-10-11
 */

open class AKZoomView : FrameLayout {
    ...
    private fun processSingleTouchEvent(ev: MotionEvent) {
        ...
        val touchingMiniMap = (x >= 10.0f && x <= 10.0f + w
                && y >= 10.0f && y <= 10.0f + h)
    ...
    override fun dispatchDraw(canvas: Canvas) {
        ...
        smoothZoomX = clamp(
            0.5f * width / smoothZoom, smoothZoomX,
            width - 0.5f * width / smoothZoom
        )
        smoothZoomY = clamp(
            0.5f * height / smoothZoom, smoothZoomY,
        ...
        if (isMiniMapEnabled) {
            ...
            canvas.drawRect(
                ...
                dx + 0.5f * w / zoom, dy + 0.5f * h / zoom, p
            )
